...
(1, 'A1', '2008/12/20', b'1'),
(2, 'A2', '2008/12/22', b'1'),
(3, 'A3', current_date(), b'0');
insert into Student(StudentID, StudentName, Address, Phone, `Status`, ClassID) values
(1, 'phuong', 'Ha noi', '0912113113', 1, 1),
(2, 'dong', 'Hai phong', '', 1, 1),
(3, 'hiu', 'HCM', '0123123123', 0, 2);
...
update Student set ClassID = 2 where StudentName = 'Phuong';
